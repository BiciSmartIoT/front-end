    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-black px-6">
      <div className="w-full max-w-[450px] bg-[#0A0A0A] border border-white/5 p-12 shadow-2xl">
        <div className="text-center mb-10">
          <h2 className="text-sm font-black italic uppercase tracking-[0.2em] mb-1">Login</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="space-y-2">
            <label className="text-[9px] font-black uppercase text-gray-400 tracking-tighter">Email Address</label>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <label className="text-[9px] font-black uppercase text-gray-400 tracking-tighter">Password</label>
              <button type="button" className="text-[9px] font-black uppercase text-primary hover:underline">Forgot Password?</button>
            </div>
            <div className="relative flex items-center">
              <input 
                type="password" 
          ...
          <Button type="submit" className="w-full py-7 text-xs italic group" disabled={loading}>
            {loading ? "PROCESSING..." : (
        ...
        <div className="mt-10 flex items-center gap-4">
          ...
          <span className="text-[8px] font-bold text-gray-600 uppercase tracking-widest">Or connect with</span>
          <div className="h-[1px] flex-1 bg-white/5" />
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest leading-relaxed">
            ...
            <Link href="/register" className="text-primary hover:text-white transition-colors">Register Now</Link>
          </p>
        </div>
      </div>
    </div>
...
function SocialButton({ label }: { label: string }) {
  return (
    <button className="flex items-center justify-center gap-2 border border-white/5 bg-transparent py-3 hover:bg-white/5 transition-colors group">
       <span className="text-[9px] font-black uppercase tracking-tighter text-gray-400 group-hover:text-white">{label}</span>
    </button>
  );
}